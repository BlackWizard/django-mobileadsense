...
def adsense(request, client, slot, ad_type="text_image", channel="", 
            format="mobile_single", markup="xhtml", oe="utf8", 
            output="xhtml", timeout=1, fail_silently=False):
    a = AdSense(request, client, slot, ad_type, channel, format, markup, oe, output)
...
class AdSense(UserDict):
    ...
    def __init__(self, request, publisher_id, slot_id, ad_type="text_image", channel="", 
